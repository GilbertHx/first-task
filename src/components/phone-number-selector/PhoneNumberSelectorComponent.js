import './PhoneNumberSelectorComponent.scss';

function PhoneNumberSelectorComponent ({handleChange, values, errors}) {
  return (
      <div className="country-code-selector">
        <div className="input-data c-cod ">
            ...
            {errors.prefix && <p className="error-field">{errors.prefix}</p>}
        </div>
        
         <div className="input-data c-num">
            <input
                tabIndex="3"
                name='mobile'
                ...
                type="tel"
                inputMode="numeric"
                className={errors.mobile ? 'form-input form-input-error': 'form-input'}
                value={values.mobile}
                onChange={handleChange}
                required
            />
            <hr className="underline"/>
            {errors.mobile && <p className="error-field">{errors.mobile}</p>}
        </div> 
      </div>
  );
}

export default PhoneNumberSelectorComponent;
